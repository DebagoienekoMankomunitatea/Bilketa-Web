...
class DIspositivos extends MapperAbstract
{
     ...
     *
     * @param Atezate\Model\DIspositivos $model
     * @return array
     */
    public function toArray($model)
    {
        if (!$model instanceof \Atezate\Model\DIspositivos) {
     ...
     *
     * @param Atezate\Model\DIspositivos $model The model to delete
                ...
                foreach ($deleteCascade as $fk) {
                    ...
                    if (!isset($depList[$capitzalizedFk])) {
                        ...
                        if ( class_exists($relDbAdapName) && class_exists($depModelName) ) {
                            ...
                            $references = $relDbAdapter->getReference('Atezate\\Mapper\\Sql\\DbTable\\DIspositivos', $capitzalizedFk);
     ...
     */
    public function save(\Atezate\Model\DIspositivos $model)
    {
     ...
     * @return boolean If the save action was successful
     */
    public function saveRecursive(\Atezate\Model\DIspositivos $model, $useTransaction = true, $transactionTag = null)
    {
        return $this->_save($model, true, $useTransaction, $transactionTag);
    }

    protected function _save(\Atezate\Model\DIspositivos $model,
     ...
     * @param Atezate\Model\DIspositivos|null $entry The object to load the data into, or null to have one created
     * @return Atezate\Model\DIspositivos The model with the data provided
     */
    public function loadModel($data, $entry = null)
    {
        ...
        } else if ($data instanceof \Atezate\Model\DIspositivos) {
