...
{
    /**
     * $_dbTable - instance of Atezate\Mapper\DbTable\TableAbstract
     *
     * @var Atezate\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param Atezate\Mapper\DbTable\TableAbstract $dbTable
     * @return Atezate\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param Atezate\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'Atezate\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'Atezate\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\Atezate\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see Atezate\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see Atezate\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param Atezate\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\Atezate\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \Atezate\Model\Paginator($select, $this);
     ...
     * @return Atezate\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All Atezate\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param Atezate\Model\Raw\ModelAbstract|null $model
     * @return Atezate\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return Atezate\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new Atezate\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param Atezate\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \Atezate\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\Atezate\Model\Raw\ModelAbstract $model)
    {
