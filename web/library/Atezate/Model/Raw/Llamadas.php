...
class Llamadas extends ModelAbstract
{
    /**
    ...
    /**
     * Parent relation Llamadas_ibfk_4
     *
    ...
    /**
     * Parent relation Llamadas_ibfk_3
     *
    ...
    ***************************************************************************/
     ...
     *
     * @return Atezate\Mapper\Sql\Llamadas
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Atezate\Mapper\Sql\Llamadas')) {

                $this->setMapper(new \Atezate\Mapper\Sql\Llamadas);
     ...
     *
     * @return null | \Atezate\Model\Validator\Llamadas
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Atezate\\Validator\Llamadas')) {

                $this->setValidator(new \Atezate\Validator\Llamadas);
            }
        }
     ...
     *
     * @see \Mapper\Sql\Llamadas::delete
