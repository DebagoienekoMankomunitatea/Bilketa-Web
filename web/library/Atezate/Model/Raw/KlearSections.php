...
class KlearSections extends ModelAbstract
{
    ...
    ***************************************************************************/
     ...
     *
     * @return Atezate\Mapper\Sql\KlearSections
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Atezate\Mapper\Sql\KlearSections')) {

                $this->setMapper(new \Atezate\Mapper\Sql\KlearSections);
     ...
     *
     * @return null | \Atezate\Model\Validator\KlearSections
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Atezate\\Validator\KlearSections')) {

                $this->setValidator(new \Atezate\Validator\KlearSections);
            }
        }
