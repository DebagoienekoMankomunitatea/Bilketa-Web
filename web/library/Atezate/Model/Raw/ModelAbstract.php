...
abstract class ModelAbstract implements \IteratorAggregate
{
     ...
     *
     * @var Atezate\Model\Raw\ModelAbstract
     */
    protected $_mapper;
    ...
    */
     ...
     *
     * @var Atezate\Model\ModelValidatorAbstract
     */
     ...
     *
     * @param array $data
     * @return Atezate\Model\Raw\ModelAbstract
     */
     ...
     *
     * @return Atezate\Model\Mapper\MapperAbstract
     */
     ...
     *
     * @param Atezate\Model\Mapper\MapperAbstract $mapper
     * @return Atezate\Model\Raw\ModelAbstract
     */
     ...
     *
     * @see Atezate\Mapper\DbTable\TableAbstract::getPrimaryKeyName()
     ...
     *
     * @see Atezate\Model\Mapper\MapperAbstract::toArray()
     * @return array
     */
     ...
     * Saves current row
     *
     * @see Atezate\Model\Mapper\MapperAbstract::save()
     ...
     *
     * @see Atezate\Model\Mapper\MapperAbstract::saveRecursive()
