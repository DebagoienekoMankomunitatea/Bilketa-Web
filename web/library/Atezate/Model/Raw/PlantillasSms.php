...
class PlantillasSms extends ModelAbstract
{
    ...
    /**
     * Dependent relation LogSms_ibfk_2
    ...
    /**
     * Dependent relation TiposIncidencias_ibfk_2
     * Type: One-to-Many relationship
     *
    ...
    ***************************************************************************/
    ...
    /**
     * Sets dependent relations LogSms_ibfk_2
     *
    ...
    /**
     * Sets dependent relations TiposIncidencias_ibfk_2
     *
    ...
    /**
     * Gets dependent TiposIncidencias_ibfk_2
     *
     * @param string or array $where
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     ...
     *
     * @return Atezate\Mapper\Sql\PlantillasSms
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Atezate\Mapper\Sql\PlantillasSms')) {

                $this->setMapper(new \Atezate\Mapper\Sql\PlantillasSms);
     ...
     *
     * @return null | \Atezate\Model\Validator\PlantillasSms
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Atezate\\Validator\PlantillasSms')) {

                $this->setValidator(new \Atezate\Validator\PlantillasSms);
            }
        }
     ...
     *
     * @see \Mapper\Sql\PlantillasSms::delete
