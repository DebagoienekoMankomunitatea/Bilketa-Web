...
class MarcasCubo extends ModelAbstract
{
    ...
    /**
     * Dependent relation CubosTipos_ibfk_1
    ...
    ***************************************************************************/
    ...
    /**
     * Sets dependent relations CubosTipos_ibfk_1
     *
     * @param array $data An array of \Atezate\Model\Raw\CubosTipos
     * @return \Atezate\Model\Raw\MarcasCubo
     */
    public function setCubosTipos(array $data, $deleteOrphans = false)
    {
        if ($deleteOrphans === true) {

            if ($this->_CubosTipos === null) {

                $this->getCubosTipos();
            }

            $oldRelations = $this->_CubosTipos;
        ...
        $this->_CubosTipos = array();

        foreach ($data as $object) {
            $this->addCubosTipos($object);
        }
     ...
     * @return \Atezate\Model\Raw\MarcasCubo
     */
    public function addCubosTipos(\Atezate\Model\Raw\CubosTipos $data)
    {
    ...
    /**
     * Gets dependent CubosTipos_ibfk_1
     *
     * @param string or array $where
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Atezate\Model\Raw\CubosTipos
     */
     ...
     *
     * @return Atezate\Mapper\Sql\MarcasCubo
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Atezate\Mapper\Sql\MarcasCubo')) {

                $this->setMapper(new \Atezate\Mapper\Sql\MarcasCubo);
     ...
     *
     * @return null | \Atezate\Model\Validator\MarcasCubo
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Atezate\\Validator\MarcasCubo')) {

                $this->setValidator(new \Atezate\Validator\MarcasCubo);
            }
        }
     ...
     *
     * @see \Mapper\Sql\MarcasCubo::delete
