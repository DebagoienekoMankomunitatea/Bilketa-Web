...
class ResiduosTipos extends ModelAbstract
{
    ...
    /**
     * Dependent relation fk_PuntosDescarga_ResiduosTipos1
    ...
    /**
     * Dependent relation Rutas_ibfk_3
     * Type: One-to-Many relationship
     *
    ...
    public function __construct()
    {
        ...
        $this->setOnDeleteSetNullRelationships(array(
            'fk_PuntosDescarga_ResiduosTipos1'
        ));
    ...
    ***************************************************************************/
    ...
    /**
     * Sets dependent relations fk_PuntosDescarga_ResiduosTipos1
     *
     * @param array $data An array of \Atezate\Model\Raw\PuntosDescarga
     * @return \Atezate\Model\Raw\ResiduosTipos
     */
    public function setPuntosDescarga(array $data, $deleteOrphans = false)
    {
        if ($deleteOrphans === true) {

            if ($this->_PuntosDescarga === null) {

                $this->getPuntosDescarga();
            }

            $oldRelations = $this->_PuntosDescarga;
        ...
        $this->_PuntosDescarga = array();

        foreach ($data as $object) {
            $this->addPuntosDescarga($object);
        }
     ...
     * @return \Atezate\Model\Raw\ResiduosTipos
     */
    public function addPuntosDescarga(\Atezate\Model\Raw\PuntosDescarga $data)
    {
    ...
    /**
     * Gets dependent fk_PuntosDescarga_ResiduosTipos1
     *
     * @param string or array $where
     * @param string or array $orderBy
     * @param boolean $avoidLoading skip data loading if it is not already
     * @return array The array of \Atezate\Model\Raw\PuntosDescarga
     */
    ...
    /**
     * Sets dependent relations Rutas_ibfk_3
     *
     ...
     *
     * @return Atezate\Mapper\Sql\ResiduosTipos
     */
    public function getMapper()
    {
        if ($this->_mapper === null) {
            ...
            if (class_exists('\Atezate\Mapper\Sql\ResiduosTipos')) {

                $this->setMapper(new \Atezate\Mapper\Sql\ResiduosTipos);
     ...
     *
     * @return null | \Atezate\Model\Validator\ResiduosTipos
     */
    public function getValidator()
    {
        if ($this->_validator === null) {

            if (class_exists('\Atezate\\Validator\ResiduosTipos')) {

                $this->setValidator(new \Atezate\Validator\ResiduosTipos);
            }
        }
     ...
     *
     * @see \Mapper\Sql\ResiduosTipos::delete
     * @return int|boolean Number of rows deleted or boolean if doing soft delete
     */
    public function deleteRowByPrimaryKey()
    {
        if ($this->getResiduosTiposId() === null) {
            $this->_logger->log('The value for ResiduosTiposId cannot be null in deleteRowByPrimaryKey for ' . get_class($this), \Zend_Log::ERR);
            throw new \Exception('Primary Key does not contain a value');
        }

        return $this->getMapper()->getDbTable()->delete(
            'residuosTiposId = ' .
             $this->getMapper()->getDbTable()->getAdapter()->quote($this->getResiduosTiposId())
        );
    }
}
