...
class Atezate_Model_FilterEmailByContribuyente extends Atezate_Model_FilterAbstract
{
    ...
    public function getEmailsByContribuyente($contribuyenteId)
    {
        ...
        $contribuyente = $contribuyenteMapper->findOneByField($this->_quoteInto('contribuyenteId'), $contribuyenteId);
