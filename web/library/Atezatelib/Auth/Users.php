<?php
use \Atezate\Mapper\Sql\KlearUsers as KlearUsersMapper;

class Atezatelib_Auth_Users implements Klear_Auth_Adapter_Interfaces_BasicUserMapper
{
    protected $_dbTable;
    ...
    public function findByLogin($login)
    {
        ...
        if ($row) {
            ...
            $user = new Atezatelib_Auth_Model_User();
